        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card border border-border rounded-xl p-6">
                ...
                >
                    <label
                        htmlFor="COD"
                        className={`flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition-all ${field.value === "COD"
                    ...
                    <label
                        htmlFor="VNPAY"
                        className={`flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition-all ${field.value === "VNPAY"
                                ? "border-primary bg-primary/5"
                                : "border-border hover:border-muted-foreground/50"
                            }`}
                    >
                    ...
                    <label
                        htmlFor="MOMO"
                        className={`flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition-all ${field.value === "MOMO"
                                ? "border-primary bg-primary/5"
                                : "border-border hover:border-muted-foreground/50"
                            }`}
                    >
