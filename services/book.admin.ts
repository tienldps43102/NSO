...
const updateBook = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.product.update({
      where: { id: input.id },
      data: {
        title: input.title,
        description: input.description,
...
const deactivateBook = orpcWithAuth
  .route({
    method: "POST",
...
const activateBook = orpcWithAuth
  .route({
    method: "POST",
...
const addAttribute = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.attribute.create({
      data: {
        name: input.name,
        value: input.value,
        productId: input.id,
...
const updateAttribute = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.attribute.update({
...
const addImage = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.productImage.create({
      data: {
        url: input.image,
...
const updateImage = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.productImage.update({
...
const addVariant = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.productVariant.create({
      data: {
        price: input.price,
        sku: randomUUID(),
...
const updateVariant = orpcWithAuth
  ...
  .handler(async ({ input }) => {
    const book = await prisma.productVariant.update({
